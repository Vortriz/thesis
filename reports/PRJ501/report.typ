...
#import "/assets/components/quddpm-circuits.typ": (
    forward-circuit, hea-block, qsc-block, qudt-circuit, reverse-circuit,
)
...
#show regex(words.join("|")): set text(
...
#multifigure(
    figure(
        image(
            "/simulations/3-qml-jl/saves/2026-04-22_191947_724_AMSGrad/training_plot.png",
        ),
    ...
    figure(
        image(
            "/simulations/3-qml-jl/saves/2026-04-22_205640_400_AMSGrad/training_plot.png",
        ),
    ...
    figure(
        image(
            "/simulations/3-qml-jl/saves/2026-04-22_210424_141_AMSGrad/training_plot.png",
        ),
    ...
    figure(
        image(
            "/simulations/3-qml-jl/saves/2026-04-23_063749_608_QNSPSA/training_plot.png",
        ),
